...
# data
_C.data = edict()
_C.data.dataset_root = osp.join(_C.root_dir, "data", "dentskan")
_C.data.num_points = 5000
_C.data.voxel_size = None
_C.data.rotation_magnitude = 40.0
...
_C.coarse_matching.overlap_threshold = 0.5
